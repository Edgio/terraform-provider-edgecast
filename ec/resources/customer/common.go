...
// buildCustomerService builds the SDK Customer service to manage Customer resources
func buildCustomerService(config api.ClientConfig) (*customer.CustomerService, error) {
