...
func (c *OriginApiClient) AddHttpLargeOrigin(origin *AddOriginRequest) (*AddOriginResponse, error) {
	request, err := c.BaseApiClient.BuildRequest("POST", fmt.Sprintf("v2/mcc/customers/%s/origins/httplarge", c.AccountNumber), origin)
...
func (c *OriginApiClient) GetHttpLargeOrigin(id int) (*Origin, error) {
	request, err := c.BaseApiClient.BuildRequest("GET", fmt.Sprintf("v2/mcc/customers/%s/origins/httplarge/%d", c.AccountNumber, id), nil)
...
func (c *OriginApiClient) DeleteOrigin(id int) error {
	request, err := c.BaseApiClient.BuildRequest("DELETE", fmt.Sprintf("v2/mcc/customers/%s/origins/%d", c.AccountNumber, id), nil)
